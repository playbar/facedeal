...
PREDICTOR_PATH = "../dataset/model/shape_predictor_68_face_landmarks.dat"
SCALE_FACTOR = 1
FEATURE_AMOUNT = 11
...
im1, landmarks1 = read_im_and_landmarks("../img/0.png")
im2, landmarks2 = read_im_and_landmarks("../img/1.png")
